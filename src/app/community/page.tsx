      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#1877F2] hover:bg-[#166FE5] text-white font-bold rounded-xl transition-colors shadow-lg shadow-[#1877F2]/25"
            >
        ...
        <div className="bg-gradient-to-br from-slate-100 dark:from-navy-900 to-slate-50 dark:to-navy-800 border border-slate-200 dark:border-navy-700/50 rounded-2xl p-8 sm:p-12 text-center">
          ...
          <p className="text-slate-600 dark:text-navy-300 max-w-lg mx-auto mb-8">
            Our Discord channel is the central hub for all SOIES Nepal community
            interactions. Message us on Facebook to join and connect with your fellow IE students.
          </p>
          <a
            href="https://www.facebook.com/soiesnepal"
            target="_blank" rel="noopener noreferrer"
          ...
          >
            <ExternalLink size={18} /> Message Us To Join Discord Channel
          </a>
        </div>
      </div>
    </div>
